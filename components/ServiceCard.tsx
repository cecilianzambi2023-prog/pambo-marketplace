...
export const ServiceCard: React.FC<ServiceCardProps> = ({ service, onViewService, onContactSupplier }) => {
  // Check if seller has paid subscription
  const isPaidTier = service.seller_subscription_tier && 
  ...
  return (
    ...
    >
      ...
      <div className="p-4 flex-1 flex flex-col">
        <p className="text-xs font-semibold text-orange-600 uppercase tracking-wider mb-1">{service.category}</p>
        ...
        <div className="mt-auto">
             {isPaidTier && service.seller_phone ? (
                ...
                <button 
                  onClick={(e) => { e.stopPropagation(); onContactSupplier(service); }}
