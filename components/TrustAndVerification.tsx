...
const TrustFeature: React.FC<{ icon: React.ReactNode; title: string; description: string }> = ({
  icon,
  title,
  description
}) => (
  <div className="flex items-start gap-4">
    <div className="bg-blue-100 text-blue-600 p-3 rounded-full shrink-0">{icon}</div>
    <div>
  ...
  const features = [
    {
      ...
      description:
        "We verify every seller's identity and business registration to ensure a safe marketplace."
    },
    {
      icon: <Wallet size={24} />,
    ...
    },
    {
      ...
      description:
        'Help us maintain quality. Easily report any suspicious listings for admin review.'
    }
  ];
