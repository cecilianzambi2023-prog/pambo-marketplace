        ...
        <div className="p-6">
          {step === 1 && (
            <div className="text-center">
              <div className="mb-6 p-4 bg-orange-50 rounded-lg text-orange-800 text-sm">
                To maintain a safe marketplace, all sellers must verify their identity and product
                inventory.
              </div>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <p className="font-semibold text-gray-700">
                    {isAnalyzing
                      ...
                      : 'Upload National ID / Business Permit'}
                  </p>
          ...
          {step === 2 && analysisResult && (
            <div>
              ...
              <div
                className={`p-4 rounded-lg mb-6 ${analysisResult.isSuspicious ? 'bg-red-50 border border-red-200' : 'bg-green-50 border border-green-200'}`}
              >
