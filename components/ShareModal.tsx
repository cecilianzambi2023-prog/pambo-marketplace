...
export const ShareModal: React.FC<ShareModalProps> = ({
  ...
  const shareMessage = listingPrice
    ? `Check out this listing: ${listingTitle}\nPrice: ${currency} ${listingPrice.toLocaleString()}\n${listingUrl}`
    : `Check out this listing: ${listingTitle}\n${listingUrl}`;
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-bold text-gray-800">Share Listing</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="mb-6">
          ...
          <p className="font-semibold text-gray-800 line-clamp-2">{listingTitle}</p>
          {listingPrice && (
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-4 rounded-lg transition flex items-center justify-center gap-2"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-4 p-3 bg-gray-50 rounded-lg">
          <p className="text-xs text-gray-600 break-all">{listingUrl}</p>
        </div>
      </div>
    </div>
  );
