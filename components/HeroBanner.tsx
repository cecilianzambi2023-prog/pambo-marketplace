    ...
    <div className="relative bg-gray-800 rounded-lg overflow-hidden min-h-[350px] md:min-h-[400px] flex items-center">
        ...
        <div className="relative container mx-auto px-4 lg:px-8 text-white z-10">
             <div className="max-w-xl">
                 <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-4" style={{textShadow: '0 2px 4px rgba(0,0,0,0.5)'}}>
                     The Heart of Kenyan Commerce
                 </h1>
                 <p className="text-lg text-gray-200 mb-8" style={{textShadow: '0 1px 3px rgba(0,0,0,0.5)'}}>
                     Discover, buy, and sell anything. From wholesale goods to professional services, Pambo is your trusted digital marketplace.
                 </p>
                 <div className="flex flex-col sm:flex-row gap-4">
                     <a href="#" className="bg-orange-500 text-white font-bold py-3 px-6 rounded-lg hover:bg-orange-600 transition shadow-lg flex items-center justify-center gap-2">
