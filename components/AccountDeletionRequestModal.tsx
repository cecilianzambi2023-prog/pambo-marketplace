...
export const AccountDeletionRequestModal: React.FC<AccountDeletionRequestModalProps> = ({
  isOpen,
  onClose,
  onConfirm
}) => {
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden relative">
        <div className="p-8 text-center">
          ...
          <p className="text-gray-600 text-sm">
            Are you sure you want to request the deletion of your account? This action is permanent
            and cannot be undone. Your request will be sent to an administrator for review and
            approval.
          </p>
        </div>
